...
fn fuzzfound_01() {
    ...
    // know to count the young gen reference). If we unconditionally mark unbuffered, it's probably
    // fine (we just might do extra work sometimes). If we unconditionally mark live, we'll
